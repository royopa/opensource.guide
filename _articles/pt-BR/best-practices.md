...
description: Facilitar sua vida como um mantenedor open source, desde os processos de documentação até a alavancagem da sua comunidade.
class: best-practices
toc:
  what-does-it-mean-to-be-a-maintainer: "O que significa ser um mantenedor?"
  documenting-your-processes: "Documentar seus processos"
  learning-to-say-no: "Aprenda a dizer não"
  leverage-your-community: "Alavanque sua comunidade"
  bring-in-the-robots: "Use robôs"
  its-okay-to-hit-pause: "Tudo bem se der uma pausa"
order: 5
...
Se você mantém um projeto open source usado por várias pessoas, pode ter notado que está programando menos e respondendo mais dúvidas.

Nos estágios iniciais de eum projeto, você está experimentando com novas ideias e tomando decisões baseadas no que você quer. A medida que o projeto aumenta sua popularidade, você vai se ver trabalhando mais com seus usuários e contribuidores.

Manter um projeto requer mais do que código. Essas tarefas são frequentemente inesperadas, mas são extremamente importantes para um projeto em crescimento. Nós reunimos algumas formas de facilitar sua vida, desde os processos de documentação até a alavancagem da sua comunidade.

## Documentar seus processos

Escrever é uma das coisas mais importantes que você pode fazer como um mantenedor.

A documentação não apenas clarifica seu próprio pensamento, mas ajuda as outras pessoas a entender o que você precisa ou espera, mesmo antes que elas perguntem.

Escrever torna mais fácil dizer não quando algo não encaixa em seu escopo. Também facilita que as pessoas colaborem e ajudem. Você nunca sabe quem pode estar lendo ou usando seu projeto.

Mesmo se você não usar parágrafos completos, anotar alguns pontos em tópicos é melhor do que não escrever nada.
...
<aside markdown="1" class="pquote">
  ...
  Eu busquei por isso. Não me esforçei para surgir com uma solução completa. Em vez de ter uma solução meia-boca, eu queria ter dito "Eu não tenho tempo para isto agora, mas vou acrescentá-lo a lista de coisas-interessantes-para-se-ter no futuro."
